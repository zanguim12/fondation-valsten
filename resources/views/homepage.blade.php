...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"><img src="assets/img/Logos VALSTEN.png"
                    alt="..." /><br />VALSTEN</a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    <li class="nav-item"><a class="nav-link" href="#services">Village des Arts</a></li>
                    <li class="nav-item"><a class="nav-link" href="#portfolio">Loisirs</a></li>
                    <li class="nav-item"><a class="nav-link" href="#portfolio">Sports</a></li>
                    <li class="nav-item"><a class="nav-link" href="#portfolio">Technologiedu Numerique</a></li>
    ...
    <header class="masthead">
        <div>
            <div class="masthead-heading text-uppercase">Bienvenue A lA FONDATION VALSTEN</div>
            <div class="masthead-subheading">Amélioration des conditions de vie en vue de l’épanouissement des
                populations</div>
